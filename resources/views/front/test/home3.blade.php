        ...
        <section class="pt-2 pb-lg-5 pb-md-5 pb-sm-2" style="background-color: #FFFFFF">
            <div class="container justify-content-center hides-for-small pt-lg-4 pt-md-4 pt-sm-0 mb-0">
                <div class="justify-content-center d-flex pb-lg-5 pb-md-5 pb-sm-5 mb-4 mb-sm-4 mb-lg-0">
                            <h6 class="mb-0" style="font-family: MVAWAHEED; text-align: right; font-size: 25px">އެންމެ ފަހުގެ ވީޑިއޯ</h6>
                </div>
                    ...
                    <div class="col-6">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24.824" height="24.824"
                            ...
                            <g transform="translate(-422.131 -1924.987)">
                                <rect width="23.324" height="23.324" rx="11.662" transform="translate(422.881 1925.737)"
                                      fill="rgba(255,255,255,0)" stroke="#fff" stroke-miterlimit="10"
                                      stroke-width="1.5"/>
                                <g transform="translate(429.024 1930.901)">
                                    <rect width="2.414" height="7.797" transform="translate(0.232 3.898)" fill="#fff"/>
                                    <path
                                        d="M327.3,193.734a1.439,1.439,0,1,0-1.427-1.439A1.434,1.434,0,0,0,327.3,193.734Z"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24.824" height="24.824"
                            ...
                            <g transform="translate(-477.023 -1924.987)">
                                <rect width="23.324" height="23.324" rx="11.662" transform="translate(477.773 1925.737)"
