...
<div class="">
            ...
            <div class="flex justify-between pb-4 pt-4">
                <div class="flex rounded-full border-solid border hover:bg-sukungreen-200">
                    ...
                    <input placeholder="" type="text"
                           class="rounded-full rounded-l-none bg-sukun-official text-white hover:bg-sukungreen-200 focus:outline-none focus:bg-sukungreen-200"
    ...
    <section>
        <div class="container mx-auto px-10">
            ...
            <div class="flex pt-10">
                <div class="w-2/12 bg-gray-400 mr-5" style=""></div>
