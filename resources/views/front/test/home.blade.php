        ...
        <section class="pt-4" style="background-color: #FFFFFF">
            ...
            <div class="card-body p-0">
                <div class="row no-gutters">
                    <div class="col-lg-6 align-self-stretch bg-img-cover d-none d-lg-flex" style='background-image: url("https://source.unsplash.com/npxXWgQ33ZQ/1200x800"); height:322px'></div>
