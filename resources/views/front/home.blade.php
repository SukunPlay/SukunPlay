                                    ...
                                    <div class="card my-5 " style="border-radius: 20px;border:none">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-12 col-md-12 col-lg-4 col-xl-4">
                                                    <button type="button" class="btn btn-default align-content-end" data-dismiss="modal"><i class="far fa-window-close fa-3x" style="position: fixed; top: 1em; right: 1em; color: white"></i></button>
                                                <div class="card-body">
